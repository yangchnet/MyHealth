    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover', models.ImageField(blank=True, default='', null=True, upload_to='', verbose_name='封面')),
            ],
        ),
        migrations.CreateModel(
            name='Data',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('datatype', models.CharField(choices=[('pressure', '血压数据'), ('oxygen', '血氧数据'), ('heartbeat', '心跳数据'), ('tem', '体温数据')], default='heartbeat', max_length=20, verbose_name='数据类型')),
        ...
        migrations.AddField(
            model_name='match',
            name='doctor',
            field=models.ForeignKey(default='1', on_delete=django.db.models.deletion.CASCADE, to='myhealth.DoctorUser', verbose_name='医生'),
        ),
        migrations.AddField(
            model_name='match',
            name='normaluser',
            field=models.ForeignKey(default='1', on_delete=django.db.models.deletion.CASCADE, to='myhealth.NormalUser', verbose_name='普通用户'),
        ),
        migrations.AddField(
            model_name='data',
            name='doctor',
            field=models.ForeignKey(default='1', on_delete=django.db.models.deletion.CASCADE, to='myhealth.DoctorUser', verbose_name='个人医生'),
        ),
        migrations.AddField(
            model_name='data',
            name='own',
            field=models.ForeignKey(default='1', on_delete=django.db.models.deletion.CASCADE, to='myhealth.NormalUser', verbose_name='条目所有者'),
        ),
    ]
