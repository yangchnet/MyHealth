    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, default='', null=True, upload_to='', verbose_name='头像')),
            ],
        ),
        migrations.CreateModel(
            name='NormalUser',
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, default=None, null=True, upload_to='', verbose_name='头像')),
            ],
        ),
        migrations.AddField(
            model_name='mhuser',
        ...
        migrations.AddField(
            model_name='data',
            name='doctor',
            field=models.ForeignKey(default='1', on_delete=django.db.models.deletion.CASCADE, to='mhuser.DoctorUser', verbose_name='个人医生'),
        ),
        migrations.AddField(
            model_name='data',
            name='own',
